...
### Changed
- Require Java 17.
- Make the extension annotation processor support the latest source version provided by the running JDK.
- Upgrade `wakamiti-starter` and the Maven build plugins.
