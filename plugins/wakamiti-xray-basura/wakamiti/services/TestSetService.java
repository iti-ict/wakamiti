...
public class TestSetService {
    ...
    public static String createTestSet(String testSetName, String description) {
        try {
            ...
            fields.addProperty("summary", testSetName);
            ...
            issueType.addProperty("name", "Test Set");
            ...
            if (response.statusCode() == 201) {
                ...
                System.out.println("Failed to create Test Set. HTTP error code: " + response.statusCode());
