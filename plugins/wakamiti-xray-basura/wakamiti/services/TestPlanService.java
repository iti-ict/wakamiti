...
public class TestPlanService {
    ...
    public static String createTestPlan(String testPlanName, String description) {
        try {
            ...
            fields.addProperty("summary", testPlanName);
            ...
            issueType.addProperty("name", "Test Plan");
            ...
            if (response.statusCode() == 201) {
                ...
                System.out.println("Failed to create Test Plan. HTTP error code: " + response.statusCode());
