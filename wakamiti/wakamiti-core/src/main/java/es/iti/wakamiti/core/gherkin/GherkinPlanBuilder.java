...
public class GherkinPlanBuilder implements PlanBuilder, Configurable {
    ...
    protected PlanNodeBuilder createStep(
        ...
        if (step.getArgument() != null) {
            if (step.getArgument() instanceof es.iti.commons.gherkin.DataTable) {
                node.setData(
                        new DataTable(toArray((es.iti.commons.gherkin.DataTable) step.getArgument()))
                );
    ...
    private String[][] toArray(es.iti.commons.gherkin.DataTable table) {
