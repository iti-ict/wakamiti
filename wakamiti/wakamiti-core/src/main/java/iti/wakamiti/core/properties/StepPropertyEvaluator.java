 ...
 */
package iti.wakamiti.core.properties;
...
import iti.wakamiti.api.util.JsonUtils;
import iti.wakamiti.api.util.XmlUtils;
 ...
 */
@Extension(provider = "iti.wakamiti", name = "step-property-resolver",
        extensionPoint = "iti.wakamiti.api.extensions.PropertyEvaluator", priority = 2)
