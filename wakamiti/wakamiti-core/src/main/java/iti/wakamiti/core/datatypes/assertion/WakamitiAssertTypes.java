...
import iti.wakamiti.core.datatypes.WakamitiDataTypeBase;
import iti.wakamiti.core.datatypes.WakamitiNumberDataType;



@Extension(provider = "iti.wakamiti", name = "assertion-types", version = "1.1")
