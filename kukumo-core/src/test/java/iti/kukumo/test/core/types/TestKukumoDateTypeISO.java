...
public class TestKukumoDateTypeISO {
    ...
    public void testISODate() {
        ...
        for (Locale locale : Locale.getAvailableLocales()) {
            ...
            Assertions.assertThat(DATE_TYPE.parse(locale, "2018-05-30")).isEqualTo(LocalDate.of(2018,5,30));
        }
    }
    ...
    public void testISOTime() {
        ...
        for (Locale locale : Locale.getAvailableLocales()) {
            ...
            Assertions.assertThat(TIME_TYPE.parse(locale, "17:35:29")).isEqualTo(LocalTime.of(17, 35, 29));
            Assertions.assertThat(TIME_TYPE.matcher(locale, "17:35:29.743").matches()).isTrue();
            Assertions.assertThat(TIME_TYPE.parse(locale, "17:35:29.743")).isEqualTo(LocalTime.of(17, 35, 29, 743000000));
        }
    }
    ...
    public void testISODateTime() {
        // ISO time should be accepted by any locale
        for (Locale locale : Locale.getAvailableLocales()) {
            Assertions.assertThat(DATETIME_TYPE.matcher(locale, "2018-05-30T17:35").matches()).isTrue();
            Assertions.assertThat(DATETIME_TYPE.parse(locale, "2018-05-30T17:35")).isEqualTo(LocalDateTime.of(2018,5,30,17, 35));
            Assertions.assertThat(DATETIME_TYPE.matcher(locale, "2018-05-30T17:35:29").matches()).isTrue();
            Assertions.assertThat(DATETIME_TYPE.parse(locale, "2018-05-30T17:35:29")).isEqualTo(LocalDateTime.of(2018,5,30,17, 35, 29));
            Assertions.assertThat(DATETIME_TYPE.matcher(locale, "2018-05-30T17:35:29.743").matches()).isTrue();
            Assertions.assertThat(DATETIME_TYPE.parse(locale, "2018-05-30T17:35:29.743")).isEqualTo(LocalDateTime.of(2018,5,30,17, 35, 29, 743000000));
        }
    }
