...
import iti.wakamiti.server.domain.model.WakamitiExecution;
...
public class ExecutionResource {
    ...
    @Produces("application/json;charset=UTF-8")
    @Path("{executionID}")
    public WakamitiExecution getExecutionData(@PathParam("executionID") String executionID) {
