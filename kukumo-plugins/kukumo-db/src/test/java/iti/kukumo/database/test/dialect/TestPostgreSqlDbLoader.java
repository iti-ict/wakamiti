...
public class TestPostgreSqlDbLoader {
    ...
    public static Configuration setUp(Configuration config) throws IOException {
        ...
        GenericContainer postgresContainer = new GenericContainer("postgres:13.4")
        ...
        new JdbcTemplate(new DriverManagerDataSource(jdbcUrl, "postgres", "password")).execute("CREATE DATABASE mydb");


        JdbcTemplate jdbcTemplate = new JdbcTemplate(new DriverManagerDataSource(jdbcUrl + "mydb", "postgres", "password"));
