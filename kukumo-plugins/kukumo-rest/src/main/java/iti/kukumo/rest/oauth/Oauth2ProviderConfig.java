...
public class Oauth2ProviderConfig {
    ...
    public void checkParameters() {
        if (isNull(type)) {
            throw new KukumoException("Missing oauth2 grant type.");
        }
        ...
        if (!missing.isEmpty()) {
            throw new KukumoException("Missing oauth2 required parameters for " + type + " grant type: " + missing);
        }
        ...
        if (!missing.isEmpty()) {
            throw new KukumoException("Missing oauth2 configuration parameters: " + missing);
        }
    }
