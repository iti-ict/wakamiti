...
A concrete example in this tutorial is querying a pet owner.
...
The third line, `Scenario: An existing owner is consulted`, is a scenario (i.e., a specific example that illustrates how 
...
- <span style="color:#ff7b7e">**FAILED**</span>: there is a validation error; the system response does not match what was
  expected.
