...
By attaching files (such as those generated by the HTML Reporter plugin) to
[Jira](https://www.atlassian.com/software/jira) and [XRay](https://www.getxray.app/) during the run, this plugin
integrates the results of a Wakamiti execution into an existing XRay test plan.
