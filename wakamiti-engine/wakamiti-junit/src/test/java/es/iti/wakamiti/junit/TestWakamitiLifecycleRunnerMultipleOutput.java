...
@AnnotatedConfiguration({
        ...
        @Property(key = WakamitiConfiguration.RESOURCE_PATH, value = "src/test/resources/features/lifecycleHooks.feature"),
        @Property(key = WakamitiConfiguration.OUTPUT_FILE_PER_TEST_CASE, value = "true"),
        @Property(key = WakamitiConfiguration.OUTPUT_FILE_PER_TEST_CASE_PATH, value = "target/multipleLifecycleJsons/%DATE%%TIME%"),
...
public class TestWakamitiLifecycleRunnerMultipleOutput {
