...
public class TokenScanner implements Parser.ITokenScanner {
    ...
    @Override
    public es.iti.wakamiti.core.gherkin.parser.internal.Token read() {
        try {
            String line = reader.readLine();
            Location location = new Location(++lineNumber, 0);
            return line == null ? new es.iti.wakamiti.core.gherkin.parser.internal.Token(null, location) : new Token(new GherkinLine(line), location);
        } catch (IOException e) {
