...
public class GherkinAstBuilder implements Parser.Builder<GherkinDocument> {
    ...
    private Object getTransformedNode(
    ...
    private Object getTransformedStep(
            es.iti.wakamiti.core.gherkin.parser.internal
                    .AstNode node
    ) {
    ...
    private Object getTransformedDocString(
            es.iti.wakamiti.core.gherkin.parser.internal
                    .AstNode node
    ) {
    ...
    private Object getTransformedBackground(
            es.iti.wakamiti.core.gherkin.parser.internal
                    .AstNode node
    ) {
    ...
    private Object getTransformedScenarioDefinition(
            es.iti.wakamiti.core.gherkin.parser.internal
                    .AstNode node
    ) {
    ...
    private Object getTransformedExamplesDefinition(
            es.iti.wakamiti.core.gherkin.parser.internal
                    .AstNode node
    ) {
        List<Tag> tags = getTags(node);
    ...
    private Object getTransformedDescription(
            es.iti.wakamiti.core.gherkin.parser.internal
                    .AstNode node
    ) {
        List<Token> lineTokens = node.getTokens(Parser.TokenType.Other);
    ...
    private Object getTransformedFeature(
            es.iti.wakamiti.core.gherkin.parser.internal
                    .AstNode node
    ) {
    ...
    private List<Tag> getTags(
        ...
        es.iti.wakamiti.core.gherkin.parser.internal.AstNode tagsNode = node.getSingle(
                Parser.RuleType.Tags,
                new es.iti.wakamiti.core.gherkin.parser.internal.AstNode(Parser.RuleType.None)
        );
        if (tagsNode == null) {
