...
Feature: Test 7 - Lifecycle hooks
  ...
  Scenario: Setup feature execution
    Given a number with value 4.0 and another number with value 5
    When both numbers are multiplied
    Then the result is equals to 20.0
  ...
  Scenario: Teardown feature execution
    Given a number with value 4.0 and another number with value 4
    When both numbers are multiplied
    Then the result is equals to 16.0
