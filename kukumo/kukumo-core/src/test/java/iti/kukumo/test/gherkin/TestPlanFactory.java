...
public class TestPlanFactory {
    ...
    private void assertPlan(
        ...
        properties.put(KukumoConfiguration.OUTPUT_FILE_PATH, "target/" + Path.of(resultFilename).getFileName());
        ...
        kukumo.writeOutputFile(testPlan, configuration);
        ...
        String expectedResult = Kukumo.resourceLoader().readResourceAsString(resultFilename);
    ...
    private PlanNode runPlan(
        ...
        Kukumo kukumo = Kukumo.instance();
        PlanNode testPlan = kukumo.createPlanFromConfiguration(configuration);
        testPlan = kukumo.executePlan(testPlan, configuration);
        System.out.println(printPlan(testPlan, new StringBuilder(), 0));
        return testPlan;
    }
