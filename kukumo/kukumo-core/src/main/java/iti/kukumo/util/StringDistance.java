...
public class StringDistance {
    ...
    public static List<String> closerStrings(String string, Collection<String> candidates, int limitResults) {
        Levenshtein algorithm = new Levenshtein();
        Function<String,Double> calculateDistance = candidate -> new Simil(string).getSimilarityInPercentFor(candidate);//algorithm.distance(string, candidate);
