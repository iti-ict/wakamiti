...
import iti.wakamiti.rest.log.RestAssuredLogger;
import iti.wakamiti.rest.oauth.Oauth2ProviderConfig;
...
@Extension(provider = "iti.wakamiti", name = "rest-configurator", extensionPoint = "iti.wakamiti.api.extensions.ConfigContributor")
