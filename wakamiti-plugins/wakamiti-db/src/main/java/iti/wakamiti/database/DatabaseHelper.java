...
import iti.wakamiti.database.dataset.*;
...
public class DatabaseHelper {
    ...
    private static final Logger LOGGER = AnsiLogger.of(LoggerFactory.getLogger("iti.wakamiti.database"));
    ...
    private DataSet getGeneratedKeys(Statement statement, Insert insert) throws SQLException {
        ...
        String[] pkColumns = primaryKey(insert.getTable().getName())
                .orElseThrow(() -> {
                    ...
                    return new WakamitiException(message);
                });
