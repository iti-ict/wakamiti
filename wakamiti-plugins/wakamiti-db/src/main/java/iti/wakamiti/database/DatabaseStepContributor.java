...
import iti.wakamiti.database.dataset.CsvDataSet;
import iti.wakamiti.database.dataset.DataSet;
import iti.wakamiti.database.dataset.DataTableDataSet;
import iti.wakamiti.database.dataset.InlineDataSet;
import iti.wakamiti.database.dataset.MultiDataSet;
import iti.wakamiti.database.dataset.OoxmlDataSet;
import net.sf.jsqlparser.JSQLParserException;
import org.apache.commons.io.IOUtils;


@Extension(provider = "iti.wakamiti", name = "database-steps", version = "1.1")
...
public class DatabaseStepContributor implements StepContributor {
    ...
    private static final Logger LOGGER = WakamitiLogger
        .of(LoggerFactory.getLogger("iti.wakamiti.database"));
